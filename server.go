...
func CreateRouter(db *sql.DB) *httprouter.Router {
	...
	router.GET("/dishes", GetDishes(db))
...
func Index(db *sql.DB) func(http.ResponseWriter, *http.Request, httprouter.Params) {
...
func HealthCheck(db *sql.DB) func(http.ResponseWriter, *http.Request, httprouter.Params) {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		h := w.Header()
...
// 	var price float32
// 	db.QueryRow(`SELECT name, description, price, id FROM dish WHERE id = $1`, pID).Scan(&name, &description, &price, &id)
// 	dish := Dish{
// 		Name:        name,
...
// GetDishes ...
func GetDishes(db *sql.DB) func(http.ResponseWriter, *http.Request, httprouter.Params) {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		h := w.Header()
		h.Add("Content-Type", "application/json")
